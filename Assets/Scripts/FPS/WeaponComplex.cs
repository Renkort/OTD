...
namespace Akkerman.FPS
{
    ...
    public class WeaponComplex : HoldableItem
    {
        ...
        private void FireWeapon()
        {
            ...
            int bulletsPerShot = weaponData.bulletsPerShot;
            if (bulletsPerShot <= 0) Debug.LogError("ERROR: bulletsPerShot must be greater than zero");
        ...
        private void ReloadCompleted()
        {
            ...
            int ammoToFull = magazineSize - bulletsLeft;
            if (bulletsAmount < ammoToFull)
            {
